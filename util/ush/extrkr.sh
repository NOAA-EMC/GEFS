...
export namvitdir=${namvitdir:-$(compath.py nam/prod/nam.$PDY)}
...
case ${cmodel} in 
  ...
  gfs) set +x                                       ;
       ...
       echo " "                                     ;
       set -x                                       ;
       gfsdir=${gfsdir:-/com2/gfs/prod/gfs.${PDY}}   ;
       gfsgfile=gfs.t${CYL}z.master.grbf            ;
       gfsifile=gfs.t${CYL}z.master.grbif           ;
       COM=${COM:-/com2/gfs/${envir}/gfs.${PDY}}     ;
       fcstlen=180                                  ;
  ...
  gdas) set +x                                          ;
       ...
       echo " "                                         ;
       set -x                                           ;
       gdasdir=$(compath.py gfs/prod)/gdas.${PDY}                ;
       gdasgfile=gdas1.t${CYL}z.pgrbf                   ;
       gdasifile=gdas1.t${CYL}z.pgrbif                  ;
       COM=$(compath.py gfs)/${envir}/gdas.${PDY}                ;
       fcstlen=9                                        ;
  ...
  hdas) set +x                                          ;
       ...
       echo " "                                         ;
       set -x                                           ;
       hdasdir=$(compath.py gfs/prod)/gdas.${PDY}                ;
...
then
  ...
  synvitdir=/com2/nam/prod/nam.${PDY}
  synvitfile=nam.t${CYL}z.syndata.tcvitals.tm00
  synvit6ago_dir=/com2/nam/prod/nam.${d6ago_4ymd}
  synvit6ago_file=nam.t${d6ago_hh}z.syndata.tcvitals.tm00
  synvit6ahead_dir=/com2/nam/prod/nam.${d6ahead_4ymd}
...
#exectrkdir=/gpfs/dell1/nco/ops/nwprod/gefs.v11.3.8/util/exec
