...
$basesource/nw${envir}/gefs_legacy.${gefs_legacy_ver}/exec/global_sigzvd
fi
...
#  export SIGINP=/nw${envir}/gefs_legacy.${gefs_legacy_ver}/fix/gefs.pertback.$cycle_fcst.${meml}${ipair}
#else
#  # RLW 20150225 modify to obtain and use version for vertical structure
#  export SIGINP=$basesource/nw${envir}/gefs_legacy.${gefs_legacy_ver}/fix/gefs.pertback.$cycle_fcst.${meml}${ipair}
#fi
###teste
