...
# 20200206 rlw updated default settings for dell begin
echo updated settings for dell begin
#echo env sort before
#env | sort
#echo env sort after
export ANOMGBEXEC=${ANOMGBEXEC:-$ANOMGB}
export CLMGRB=${CLMGRB:-${HOMEgefs}/util/fix/clmgrb}
export CLMGRI=${CLMGRI:-${HOMEgefs}/util/fix/clmgri}
#echo env sort before
#env | sort
#echo env sort after
echo updated settings for dell end
# 20200206 rlw updated default settings for dell end
#  Directories.
...
cd $DATA||exit 99
################################################################################
echo settings for $0 begin
echo PGBOUT=$PGBOUT
echo PGIOUT=$PGIOUT
echo EXECUTIL=$EXECUTIL
echo FIXUTIL=$FIXUTIL
echo ANOMGBEXEC=$ANOMGBEXEC
echo GRBINDEX=$GRBINDEX
echo CLMGRB=$CLMGRB
echo CLMGRI=$CLMGRI
echo DATA=$DATA
echo settings for $0 end
#echo exit $0 for testing
#exit
################################################################################
