...
set +x
echo " "
echo "Entering sub script  ensadd_grb1.sh"
echo "File 1 =$1"
echo "File 2 =$2"
echo "File 3 =$3"
echo "File 4 =$4"
...
export pgm=global_ensadd_grb1
. prep_step

startmsg
#DHOU, 01/21/2013 , For prod, EXECGLOBAL=EXECgefs, should be no problem
#eval $EXECGLOBAL/global_ensadd_grb1 <<EOF >> $pgmout 2> errfile
eval $EXECgefs/global_ensadd_grb1 <<EOF >> $pgmout 2> errfile
 &namin
...
set +x
echo " "
echo "Leaving sub script  ensadd_grb1.sh"
echo " "
set -x
