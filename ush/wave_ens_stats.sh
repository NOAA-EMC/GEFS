...
#                                                                              +
#                                                                              +
# March, 2020 - Roberto Padilla-Hernandez                                      +
#               For GEFS-WAVE                                                  +
#                                                                              +
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - --+ + + ++
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - --+ + + ++
...
# 0.b Set general parameter settings
  ...
  case $prepar in
    ...
    DIRP)   ascale='0' ;
             ...
             nnip=${nip} ;
             parcode='10 0 10'  ;;
    IMWF)   ascale=(5.0 7.0 9.0 11.0 13.0 15.0 17.0 19.0) ;
             scale=${ascale[@]}
             npart=0 ;
             nip='tm' ;
             nnip=${nip} ;
...
#    while [ ${nme} -lt ${nmemb} ]
    ...
    do
      ...
      infile=../../${para}.t${cyc}z.p${im}.f${hhh}.grib2



     if [ "${im}" = "00" ]
      then
        if [ ! -f ../../${para}.t${cyc}z.c${im}.f${hhh}.grib2 ]
         then
           ...
           echo '***************************************** '
           echo "***            FATAL ERROR            *** "
           echo "--- No ../../${para}.t${cyc}z.c${im}.f${hhh}.grib2 file --- "
           echo '***************************************** '
           echo ' '
           [[ "$LOUD" = YES ]] && set -x
           echo "No ../../${para}.t${cyc}z.c${im}.f${hhh}.grib2 " >> $wavelog
           err=3;export err;./err_chk
           exit_code=3
         else
              echo "--- ../../${para}.t${cyc}z.c${im}.f${hhh}.grib2 file Exist --- "
      ...
      if [ "${im}" = "00" ]
      then
        infile=../../${para}.t${cyc}z.c${im}.f${hhh}.grib2
