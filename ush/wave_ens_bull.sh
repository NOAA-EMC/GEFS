...
#
  $gribexec/wgrib2 ../gribfile -new_grid_winds earth \
...
#
    valpdy=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match mean -vt \
          | sed 's/[,=]/ /g' | awk '{print $NF}' | cut -c1-8`)
    vald=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match mean -vt \
          | sed 's/[,=]/ /g' | awk '{print $NF}' | cut -c7-8`)
    valt=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match mean -vt \
          | sed 's/[,=]/ /g' | awk '{print $NF}' | cut -c9-10`)
    hsb=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match mean -lon \
          ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    hspb=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match spread \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    tpb=(`$gribexec/wgrib2 grbint.${bnom} -match PERPW -match mean -lon \
          ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    tspb=(`$gribexec/wgrib2 grbint.${bnom} -match PERPW -match spread \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    ub=(`$gribexec/wgrib2 grbint.${bnom} -match WIND -match mean -lon \
          ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    usb=(`$gribexec/wgrib2 grbint.${bnom} -match WIND -match spread -lon \
          ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    p1b=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match 'prob >0.6' \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    p2b=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match 'prob >1' \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    p3b=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match 'prob >2' \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    p4b=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match 'prob >5.5' \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    p5b=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match 'prob >7' \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
    p6b=(`$gribexec/wgrib2 grbint.${bnom} -match HTSGW -match 'prob >9' \
          -lon ${blon} ${blat} | sed 's/[,=]/ /g' | awk '{print $NF}'`)
#
...
#
    ...
    printf " Model    : NCEP Global Ensemble Forecast System  (${MDC})\n" >> $bfil
    ...
    printf " NOAA/NCEP Environmental Modeling Center, $PDY" >> $bfil
#
