! $Id: ESMF_FieldGet.cppF90,v 1.2.2.45 2010/02/01 20:50:32 svasquez Exp $
!
...
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr1DI1(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
 ...
 type(ESMF_Field), intent(in) :: field 
 integer, intent(in), optional :: localDe 
 integer (ESMF_KIND_I1), dimension(:), pointer :: farray 
 integer, intent(out), optional :: exclusiveLBound(:) 
 integer, intent(out), optional :: exclusiveUBound(:) 
 integer, intent(out), optional :: exclusiveCount(:) 
 integer, intent(out), optional :: computationalLBound(:) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr2DI1(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr3DI1(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr4DI1(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr5DI1(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr6DI1(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr7DI1(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr1DI2(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
 ...
 type(ESMF_Field), intent(in) :: field 
 integer, intent(in), optional :: localDe 
 integer (ESMF_KIND_I2), dimension(:), pointer :: farray 
 integer, intent(out), optional :: exclusiveLBound(:) 
 integer, intent(out), optional :: exclusiveUBound(:) 
 integer, intent(out), optional :: exclusiveCount(:) 
 integer, intent(out), optional :: computationalLBound(:) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr2DI2(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr3DI2(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr4DI2(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr5DI2(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr6DI2(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr7DI2(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr1DI4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
 ...
 type(ESMF_Field), intent(in) :: field 
 integer, intent(in), optional :: localDe 
 integer (ESMF_KIND_I4), dimension(:), pointer :: farray 
 integer, intent(out), optional :: exclusiveLBound(:) 
 integer, intent(out), optional :: exclusiveUBound(:) 
 integer, intent(out), optional :: exclusiveCount(:) 
 integer, intent(out), optional :: computationalLBound(:) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr1DI8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
 ...
 type(ESMF_Field), intent(in) :: field 
 integer, intent(in), optional :: localDe 
 integer (ESMF_KIND_I8), dimension(:), pointer :: farray 
 integer, intent(out), optional :: exclusiveLBound(:) 
 integer, intent(out), optional :: exclusiveUBound(:) 
 integer, intent(out), optional :: exclusiveCount(:) 
 integer, intent(out), optional :: computationalLBound(:) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr1DR4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
 ...
 type(ESMF_Field), intent(in) :: field 
 integer, intent(in), optional :: localDe 
 real (ESMF_KIND_R4), dimension(:), pointer :: farray 
 integer, intent(out), optional :: exclusiveLBound(:) 
 integer, intent(out), optional :: exclusiveUBound(:) 
 integer, intent(out), optional :: exclusiveCount(:) 
 integer, intent(out), optional :: computationalLBound(:) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr1DR8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr2DI4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr2DI8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr2DR4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr2DR8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr3DI4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr3DI8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr3DR4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr3DR8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr4DI4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr4DI8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr4DR4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr4DR8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr5DI4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr5DI8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr5DR4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr5DR8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr6DI4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr6DI8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr6DR4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr6DR8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr7DI4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr7DI8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr7DR4(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_FieldGetDataPtr" 
 subroutine ESMF_FieldGetDataPtr7DR8(field, localDe, farray, & 
 exclusiveLBound, exclusiveUBound, exclusiveCount, & 
 computationalLBound, computationalUBound, computationalCount, & 
 totalLBound, totalUBound, totalCount, rc) 
...
! internal local variables
    ...
    call ESMF_GridGet(grid, localDeCount=localDeCount, dimCount=gridrank, &
      distgridToGridMap=dg2gm, rc=localrc)
    if (ESMF_LogMsgFoundError(localrc, &
        ESMF_ERR_PASSTHRU, &
        ESMF_CONTEXT, rc)) return
    ! default localDe
    ...
    call ESMF_GridGet(grid, localDe=l_localDe, staggerloc=l_staggerloc, &
    ...
    ! otherwise we don't have to worry about this.
    if(uglb_size /= 0) then
        do i = 1, arrayrank
