! $Id: ESMF_ArrayGet.cppF90,v 1.30.2.11 2010/02/01 20:49:12 svasquez Exp $
!
...
! !ARGUMENTS:
    ...
    integer, intent(out), optional :: distgridToPackedArrayMap(:)
...
!------------------------------------------------------------------------------
    ...
    count = indexCountInternal(dim, de)
...
! -------------------------- ESMF-public method ----------------------------- 
!BOP 
! !IROUTINE: ESMF_ArrayGet - Get access to PET-local Array patch via Fortran array pointer 
...
! 
! !DESCRIPTION: 
! Get Fortran pointer to the DE-local memory regions in Array object for 
...
! !ARGUMENTS:
    ...
    integer, intent(in) :: localDe
    integer, intent(out) :: totalElementMask(:)
    integer, intent(out), optional :: rc
!
!
! !DESCRIPTION:
