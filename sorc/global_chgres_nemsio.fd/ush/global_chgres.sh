...
#     SEA_ICE_
#     THRESHLD_
#     OUTPUT        Minimum allowable sea ice (in decimal %) on output
#                   grid.  Default is "0.15" or 15%.
...
export SEA_ICE_THRESHLD_OUTPUT=${SEA_ICE_THRESHLD_OUTPUT:-"0.15"}
...
/
 &options
  ...
  SEA_ICE_THRESHLD_OUTPUT=${SEA_ICE_THRESHLD_OUTPUT}
 /
EOF
