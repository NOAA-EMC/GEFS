...
ccc
        ...
        do jj = 1, jensem
         ...
         if (aaa.eq.0.0) then
          ...
          if (jj.eq.1) then
c           call stpint(rti_r,rmrf_r,9,2,aaa,bbb,1,aux,naux)
           call qtpint(rti_r,rmrf_r,9,2,aaa,bbb,1)
           ff(ii,jj) = aaa*bbb
          else
c           call stpint(rti_r,rctl_r,9,2,aaa,bbb,1,aux,naux)
...
c       call stpint(y,x,n,2,z,r,n,aux,naux)
...
c       call stpint(y,a,n,2,z,b,n,aux,naux)
