...
def load_produtil_pythonpath():
    ...
    if os.path.exists('/scratch4'):#Theia
        sys.path.append('/scratch4/NCEPDEV/global/save/glopara/svn/nceplibs/produtil/trunk/ush')
    elif os.path.exists('/gpfs') and os.path.exists('/etc/SuSE-release'):#Cray
        sys.path.append('/gpfs/hps3/emc/global/noscrub/emc.glopara/svn/nceplibs/produtil/trunk/ush')
    elif os.path.exists('/dcom') and os.path.exists('/hwrf'):#wcoss_ibm
        sys.path.append('/global/save/emc.glopara/svn/nceplibs/produtil/trunk/ush')
    elif os.path.lexists('/usrx') and os.path.realpath('/usrx').startswith('/gpfs/dell'):#wcoss_dell_p3
        print("wcoss_dell_p3")
        sys.path.append('/gpfs/dell2/emc/verification/noscrub/emc.enspara/common/git/fv3gfs/fv3gefs_c550fea3_20181004_ForHong_old/sorc/fv3gfs.fd/NEMS/tests/produtil/NCEPLIBS-pyprodutil')
    elif os.path.lexists('/jetmon'): # Jet
        print("jet")
        sys.path.append('/home/Xianwu.Xue/bin/rocoto_viewer/produtil/ush')

 
    #elif os.path.exists('c:'):#Wins
   ...
   #     raise NotImplementedError('Cannot auto-detect platform, ABORT!')
    ...
    PRODUTIL['dell']  = './fv3gefs_c550fea3_20181004_ForHong_old/sorc/fv3gfs.fd/NEMS/tests/produtil/NCEPLIBS-pyprodutil/produtil'
    PRODUTIL['gyre']  = '/gpfs/gd1/emc/global/save/emc.glopara/svn/nceplibs/produtil/trunk/ush'
    PRODUTIL['jet']  = '/home/Xianwu.Xue/bin/rocoto_viewer/produtil/ush'
    try_clusters = ('theia','luna','tide','dell','jet')
    ...
    while x != ord('q'):
        ...
        if x == curses.KEY_NPAGE:
            ...
            if page < pages:
                page = page + 1
                position = ( 1 + ( max_row * ( page - 1 ) ) )
        if x == curses.KEY_SF or x == curses.KEY_SR:
            print("xxw")
