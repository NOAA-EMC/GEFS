...
Inputs (via environment variables):
    ...
    GEFS output must be located in the WORKDIR com directory as such:
        <WORKDIR>/com/gefs/dev/gefs.<PDY>/<cyc>/chem/<directory>
...
# File patterns
#workdir_pattern = "{work_dir}/com/gefs/dev/gefs.%Y%m%d/%H/chem"
workdir_pattern = "{work_dir}/dev/com/gefs/v12.2/gefs.%Y%m%d/%H/chem"
