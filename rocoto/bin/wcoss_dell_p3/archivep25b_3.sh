...
htar -cvf ${destination_path}/gefs.${PDY}_${cyc}.pgrb2bp25_p16-p23.tar gep16* gep17* gep18* gep19* gep20* gep21* gep22* gep23*
#htar -cvf ${destination_path}/gefs.${PDY}_${cyc}.${sFolderName}.tar ${sFolderName}
