...
c
      module sig_parms
        character*500   sigpath   ! Path of sigma files
        character*500   sfluxpath ! Path of sflux files
        real            ddeg      ! Horizontal resolution of output grid
      end module sig_parms
c
...
c
      module trig_vals
        ...
        real, save :: grav = 9.80665     ! gravitational constant
        real, save :: rd = 2.8705e+2     ! dry air gas constant
